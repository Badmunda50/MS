...
from AnonXMusic.utils.clonedb import (
...
@Client.on_callback_query(filters.regex("AnonyAmousAdmin") & ~BANNED_USERS)
async def AnonyAmous_check(client: Client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@Client.on_callback_query(filters.regex("AnonyPlaylists") & ~BANNED_USERS)
@languageCB
...
import config
from AnonXMusic import Carbon, YouTube
from AnonXMusic.core.call import Anony
